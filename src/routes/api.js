...
// Analytics endpoints
router.post('/analytics/initialize', authenticateUser, analyticsController.initializeAnalytics);
router.get('/analytics/realtime', authenticateUser, analyticsController.getRealtimeData);
router.post('/analytics/data', authenticateUser, analyticsController.getAnalyticsData);
router.post('/analytics/export', authenticateUser, analyticsController.exportAnalyticsData);
