...
describe("SeaController", () => {
  ...
  describe("analyzeCampaign", () => {
    it("moet campagne analyseren en resultaat teruggeven", async () => {
      ...
      GoogleAdsService.prototype.analyzeCampaign.mockResolvedValue(
        expectedResult,
      );
      ...
      // Assert
      expect(GoogleAdsService.prototype.analyzeCampaign).toHaveBeenCalledWith(
        campaignId,
      );
  ...
  describe("getAdPerformance", () => {
    it("moet advertentie performance ophalen en teruggeven", async () => {
      ...
      GoogleAdsService.prototype.getAdPerformance.mockResolvedValue(
        expectedResult,
      );
      ...
      // Assert
      expect(GoogleAdsService.prototype.getAdPerformance).toHaveBeenCalledWith(
        adId,
      );
      expect(mockRes.json).toHaveBeenCalledWith(expectedResult);
      expect(mockNext).not.toHaveBeenCalled();
  ...
  describe("optimizeBudget", () => {
    it("moet budget optimaliseren en resultaat teruggeven", async () => {
      ...
      mockReq.params.campaignId = campaignId;
      GoogleAdsService.prototype.optimizeBudget.mockResolvedValue(
        expectedResult,
      );
      ...
      // Assert
      expect(GoogleAdsService.prototype.optimizeBudget).toHaveBeenCalledWith(
        campaignId,
      );
      expect(mockRes.json).toHaveBeenCalledWith(expectedResult);
      expect(mockNext).not.toHaveBeenCalled();
